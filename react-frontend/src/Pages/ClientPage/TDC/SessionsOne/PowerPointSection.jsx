...
// 🧩 Automatically import all images per folder
const introSlides = Object.values(
  import.meta.glob('@/assets/TdcDocs/Session1/Introduction To Land Transportation/*.jpg', { eager: true })
).map((mod) => mod.default);

const preDrivingSlides = Object.values(
  import.meta.glob('@/assets/TdcDocs/Session1/Pre-Driving Orientation on Motorcycle and Trcycle/*.jpg', { eager: true })
).map((mod) => mod.default);

const roadTrafficSlides = Object.values(
  import.meta.glob('@/assets/TdcDocs/Session1/Road and Traffic Rules/*.jpg', { eager: true })
).map((mod) => mod.default);
...
const lectures = [
  ...
  {
    id: 2,
    title: 'Pre-Driving Orientation',
    description: 'Vehicle control and safety fundamentals.',
    slides: preDrivingSlides,
  },
  {
    id: 3,
    title: 'Road Traffic Rules',
    description: 'Traffic laws and driving etiquette.',
    slides: roadTrafficSlides,
  },
];
...
const PowerPointSection = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-6">
      <h1 className="text-3xl font-semibold mb-6">Session 1 Course Materials</h1>
